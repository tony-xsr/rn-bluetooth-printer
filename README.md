...
Fork from react-native-bluetooth-escpos-printer.
...
[![GitHub license](https://img.shields.io/badge/license-MIT-blue.svg)](https://raw.githubusercontent.com/januslo/react-native-bluetooth-escpos-printer/master/LICENSE) [![npm version](https://badge.fury.io/js/react-native-bluetooth-escpos-printer.svg)](https://www.npmjs.com/package/rn-bluetooth-printer)

## Installation
### Step 1 ###
Install via NPM [Check In NPM](https://www.npmjs.com/package/rn-bluetooth-printer)
```bash
npm install rn-bluetooth-printer --save
```

Or install via github
```bash
npm install https://github.com/tungtranuit/rn-bluetooth-printer.git --save
```

### Step2 ###
Link the plugin to your RN project
```bash
react-native link rn-bluetooth-printer
```
...
await  BluetoothEscposPrinter.printText("PÅFYLLNINGSKOD：\n\r",{});
await  BluetoothEscposPrinter.printText("1611401820\n\r",{});
await  BluetoothEscposPrinter.printText("Så här gör du\n\r",{});
await  BluetoothEscposPrinter.printText("Tryck *101*1611401820# och lur/sänd.\n\r",{});
await  BluetoothEscposPrinter.printText("Färdigt att använda\n\r",{});
await  BluetoothEscposPrinter.printText("Koden är giltig till och med 2021/12/12\n\r",{});
await  BluetoothEscposPrinter.printText("Vid problem med laddning kontakta XMobile kundtjänst på 1672 eller 01-131 231 7\n\r",{});
await  BluetoothEscposPrinter.printText("code：161234145066320\n\r",{});
await  BluetoothEscposPrinter.printText("ExpiryDate："+(dateFormat(new Date(), "yyyy-mm-dd h:MM:ss"))+"\n\r",{});
