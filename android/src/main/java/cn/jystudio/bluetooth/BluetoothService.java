    ...
    private class ConnectedThread extends Thread {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mmOutStream.write(0x1C); mmOutStream.write(0x2E); // Cancels Chinese  character mode (FS .)
                mmOutStream.write(0x1B); mmOutStream.write(0x74);
                mmOutStream.write(0x10); // Select character code table (ESC t n) - n = 16(0x10) for WPC1252

               // mmOutStream.write( ( "PÅFYLLNINGSKODKöp Värdebevis  Säljare  Något gick fel, försök igen  Användarnamn").getBytes("iso-8859-1") );

              //  String myS =  "\x1C\x2E\x1B\x74\x10á, é, í, ó, ú, ü, ñ, ¿, ¡\n\n\n\n";
               //  mmOutStream.write(  myS.getBytes("iso-8859-1"));
               ...
               // Log.i("BTPWRITE----STS", new String(buffer, "iso-8859-1"));
                Map<String, Object> bundle = new HashMap<String, Object>();
